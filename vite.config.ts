...
export default defineConfig({
  ...
  server: {
    ...
    proxy: {
      ...
      "/api/auth":         { target: "http://127.0.0.1:3002", changeOrigin: true },
      "/api/books":        { target: "http://127.0.0.1:3002", changeOrigin: true },
      "/api/chapters":     { target: "http://127.0.0.1:3002", changeOrigin: true },
      "/api/coins":        { target: "http://127.0.0.1:3002", changeOrigin: true },
      "/api/weather":      { target: "http://127.0.0.1:3002", changeOrigin: true },
      "/api/open-library": { target: "http://127.0.0.1:3002", changeOrigin: true },
      "/api/search":         { target: "http://127.0.0.1:3002", changeOrigin: true },
      "/api/health":         { target: "http://127.0.0.1:3002", changeOrigin: true },
      "/api/subscriptions":  { target: "http://127.0.0.1:3002", changeOrigin: true },
      "/api/metrics":        { target: "http://127.0.0.1:3002", changeOrigin: true },
      "/api/notifications":  { target: "http://127.0.0.1:3002", changeOrigin: true },
      "/api/payments":       { target: "http://127.0.0.1:3002", changeOrigin: true },
      "/api/borrows":        { target: "http://127.0.0.1:3002", changeOrigin: true },
      "/api/marketplace":    { target: "http://127.0.0.1:3002", changeOrigin: true },
      "/api/badges":         { target: "http://127.0.0.1:3002", changeOrigin: true },
